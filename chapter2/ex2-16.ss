; My first thought would be to try to reduce an expression to only have
; one instance of each uncertain variable. I have no idea where to start though.
; For example, how would you turn par1 into par2?
